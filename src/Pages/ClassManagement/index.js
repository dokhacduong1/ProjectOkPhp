...
function ClassManagement() {
    ...
    const fetchApi = async () => {
        ...
        setDataSource(dataClass)
        setTempDataSource(dataClass)
    ...
    const handeleDelete = async () => {
        if (deleteId.length > 0) {
            deleteId.map(async (dataMap) => {
                ...
                await deleteDataClass(objectId);
                fetchApi()
            })
        }
    };
            ...
            render: (_, record) => (
                <>
                    <div className="sourceShopManagement__table-iconAction">
                        ...
                        >
                            <FormEditClass record={record} fetchApiLoad={fetchApi} />
                        </span>
                    </div>
                </>
            ),
                        ...
                        <>
                            ...
                            >
                                <Popconfirm
                                    ...
                                    description="Bạn Có Muốn Xóa Những Lớp Này Không ?"
                                    okText="Ok"
                                    cancelText="No"
                                    onConfirm={() => {
                                        handeleDelete();
